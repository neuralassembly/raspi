...
def moveHand():
    ...
    if comp_choice == 0:
        # コンピュータのグー画像表示
        app.comp_canvas.create_image((app.w/2,app.h/2), image=app.comp_gu_img, state='normal')
        app.comp_canvas.image = app.comp_gu_img
    elif comp_choice == 1:
        # コンピュータのチョキ画像表示
        app.comp_canvas.create_image((app.w/2,app.h/2), image=app.comp_choki_img, state='normal')
        app.comp_canvas.image = app.comp_choki_img
    else:
        # コンピュータのパー画像表示
        app.comp_canvas.create_image((app.w/2,app.h/2), image=app.comp_pa_img, state='normal')
        app.comp_canvas.image = app.comp_pa_img

    if your_choice == 0:
        # 人間のグー画像表示
        app.human_canvas.create_image((app.w/2,app.h/2), image=app.human_gu_img, state='normal')
        app.human_canvas.image = app.human_gu_img
    elif your_choice == 1:
        # 人間のチョキ画像表示
        app.human_canvas.create_image((app.w/2,app.h/2), image=app.human_choki_img, state='normal')
        app.human_canvas.image = app.human_choki_img
    else:
        # 人間のパー画像表示
        app.human_canvas.create_image((app.w/2,app.h/2), image=app.human_pa_img, state='normal')
        app.human_canvas.image = app.human_pa_img
    ...
    app.result_canvas.delete('all')
    app.result_canvas.create_text(200, 15, text=result_text)
...
class Application(tk.Frame):
    ...
    def janken_loop(self):
        ...
        while jankenLoop == True:
            ...
            t = threading.Thread(target=moveHand)
            t.start()
